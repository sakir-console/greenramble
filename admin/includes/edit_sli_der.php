...
if (isset($_REQUEST['submit'])) {
    ...
    if ((!empty($tit_bn) && !empty($img)) || (!empty($tit_en) && !empty($img))) {
        ...
        if ($filetype == 'image/jpeg' or $filetype == 'image/png' or $filetype == 'image/jpg') {
            ...
            $insert = "UPDATE slider SET bn_title='$tit_bn',en_title='$tit_en',bn_slog='$slo_bn',en_slog='$slo_en',img='$img' WHERE id='$sli_id'";
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        $view = "SELECT * FROM slider WHERE id='$sli_id'";
                                        ...
                                        <div class="col-xs-2">
                                            <button class="btn btn-block bg-pink waves-effect" type="submit"
                                                name="submit">Update Slider</button>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" class="btn bg-teal waves-effect">
                                        ...
                                        <button type="button" class="btn bg-pink waves-effect">
                                            <a href="dlt-sliders.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are You Sure?')">
                                                <i class="material-icons">border_color</i>
