...
if (isset($_REQUEST['submit'])) {
    ...
    if ((!empty($emr_bn) && !empty($div_id) && !empty($dis_id)) || (!empty($emr_en) && !empty($div_id) && !empty($dis_id))) {
        $insert = "INSERT INTO emergency(info_bn,info_en,div_id,dis_id) VALUES('$emr_bn','$emr_en','$div_id','$dis_id')";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            All Emergency
                            <small>ADD Emergency list/Details here.</small>
                        </h2>
                        <?php echo $msg; ?>
                    </div>
                    <div class="body">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated flipInX active"
                                            ...
                                            <div class="body">
                                                ...
                                                <label for="email_address">Emergency list/Details here.</label>
