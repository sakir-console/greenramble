     ...
     <div class="container">
         ...
         <div class="carousel_items">
             ...
             <div class="carousel-arrows">
                 <a class="prev-arrow" href="popular-places.php"><span class="fa fa-angle-left"> </span></a>
                 <a class="next-arrow" href="popular-places.php"><span class="fa fa-angle-right"> </span></a>
             </div>
         </div>
     </div>
 </div>